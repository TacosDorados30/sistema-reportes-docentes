...
def cleanup_logs():
    ...
    if len(log_files) <= 5:
        print(
            f"   ℹ️ Solo {len(log_files)} archivos de log, no se elimina nada")
        return
...
def cleanup_empty_dirs():
    ...
    protected_dirs = {"logs", "data", "reports",
                      "uploads", "backups", ".git", ".kiro"}
...
def show_disk_usage():
    ...
    directories = ["app", "dashboard", "data",
                   "logs", "reports", "uploads", "venv"]
