...
def show_personal_info():
    ...
    with col3:
        # Método 1: number_input simple (sin lag)
    ...
    with col4:
        trimestre = st.selectbox(
            "Trimestre *",
            options=["Trimestre 1", "Trimestre 2",
...
def submit_form(nombre_completo, correo_institucional, año_academico, trimestre):
    ...
    try:
        ...
        try:
            ...
            print(
                f"Formulario enviado por {nombre_completo} ({correo_institucional})")
...
def main():
    ...
    # Header
    st.markdown('<h1 class="main-header">📝 Formulario de Actividades Académicas</h1>',
                unsafe_allow_html=True)
